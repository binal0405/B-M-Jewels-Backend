...
// Add product (multipart field name must be "product_images" — matches routes)
exports.addProduct = async (req, res, next) => {
  console.log("product--->", req.body);
  try {
    const product_images = req.files?.length
      ? req.files.map((file) => multerFileToPublicRelativePath(file))
      : [];
